// Pure JS MD5 implementation for client-side checksums
...
export async function computeSubtleHash(algorithm: "SHA-1" | "SHA-256" | "SHA-512", message: string): Promise<string> {
