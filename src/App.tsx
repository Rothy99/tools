...
export default function App() {
  ...
  return (
    <div className={`min-h-screen bg-grid-pattern text-slate-900 dark:text-slate-100 flex flex-col font-sans transition-colors duration-150 overflow-x-hidden relative`}>
      ...
      <main className="flex-1 max-w-[1530px] w-full mx-auto p-3 sm:p-4 lg:p-6 relative z-10">
        {activeToolId === "privacy" ? (
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-white/75 dark:bg-slate-900/75 backdrop-blur-md rounded-2xl border border-slate-200/80 dark:border-slate-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs">
